...
namespace QtpTests
{
    ...
    public class ElementIdentification : TestBase
    {
        ...
        public void RunTest()
        {
            ...
            //var classElement = driver.FindElement(By.ClassName("buttonClassExample"));
            //classElement.Click();
            //driver.Navigate().Back();

            ////Find an element using Name
            //var nameElement = driver.FindElement(By.Name("NameExample"));
            //nameElement.Click();
            //driver.Navigate().Back();
            ...
            //By locator = By.XPath("//input[@name='selection'][1]");
